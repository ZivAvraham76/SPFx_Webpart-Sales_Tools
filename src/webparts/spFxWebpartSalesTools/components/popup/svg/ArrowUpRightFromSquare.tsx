...
const ArrowUpRightFromSquare: React.FC<ArrowUpRightFromSquareProps> = ({lmsCourseUrl, size}) => {

  console.log("ArrowUpRightFromSquare is rendering!");
  return (
    <div
    ...
    >
      <svg className="fill-current text-black block w-5 h-5" viewBox="0 0 512 512">
